...
def showVotes(root, frame1):
    ...
    ssLogo = ImageTk.PhotoImage((Image.open("img/Jds.png")).resize((40, 35), Image.Resampling.LANCZOS))
    ...
    Label(frame1, text=" JDS               :          ", font=('Helvetica', 12, 'bold')).grid(row=5, column=1)
